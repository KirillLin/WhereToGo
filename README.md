...
1.  **Экран приветствия:** Кнопка "Найти места рядом". Текст с запросом разрешения на доступ к геолокации.
2.  **Экран загрузки:** Отображается на время определения местоположения и загрузки данных с API.
3.  **Экран с результатами:**
    *   Интерактивная карта.
    *   На карте отмечены случайные места значками (markers).
    *   Кнопка "Обновить".
    *   При клике на значок места появляется всплывающее окно с названием и категорией.
