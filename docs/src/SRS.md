...
*  Премиум-функции (например, расширенные фильтры).
...
Изменение и добавление функционала.
* Окно приветствия:
...
* Для доступа к избранным необходимо зарегистрироваться окно регистрации:

  ![Регистрация](../mock/Login.png)

Если уже есть профиль, то пользователь переходит на другое окно для входа, аналогичное этому. Убрана кнопка повторного ввода пароля и вместо "Сonfirm" "Вход"

* Окно с сохранёнными местами (можно просмотреть, удалить, добавить своё описание):

  ![Избранное](../mock/Saved.png)
...
*   **Цель:** Быстро получить идею для спонтанного визита в ближайшее заведение или место. Приложение отлично подойдёт в той ситуации, когда пользователю (его компании) скучно и они не знают, куда сходить. Присутствует фильтр. Места можно сохранять, чтобы не забыть про них.
